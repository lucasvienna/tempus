...
void main() {
  group('Difference:', () {
    test('instance.from(tempus) returns a valid string', () {
      Tempus tempusAfter =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 16, 25, 30));
      Tempus tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 16, 26, 05));
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 16, 27, 00));
      from =
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 17, 40, 00));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 25, 21, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 26, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 09, 30, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 10, 25, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2018, 12, 25, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2019, 09, 25, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
      ...
      tempusBefore =
          new Tempus.fromDate(new DateTime(2048, 09, 25, 16, 40, 30));
      from =
          tempusBefore.from(tempusAfter); // DateTime(2018, 09, 25, 16, 25, 30)
